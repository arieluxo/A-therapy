      ...
      <Card className="w-full max-w-md border-0 shadow-xl">
        <CardHeader className="flex flex-col items-center gap-4 pb-2">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-light tracking-[0.3em] text-ink">A-THERAPY</h1>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-brand hover:bg-brand-deep text-white tracking-wider text-sm uppercase"
            >
